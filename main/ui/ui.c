...
lv_obj_t *ui_tds_title;
lv_obj_t *ui_tds_data;
lv_obj_t *ui_tds_unit;
/////////////TDS END////////////

/////////////EC////////////////
lv_obj_t *ui_ec;
lv_obj_t *ui_ec_icon;
lv_obj_t *ui_ec_title;
lv_obj_t *ui_ec_data;
lv_obj_t *ui_ec_unit;
/////////////EC END////////////
...
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT  ) {
      _ui_screen_change( ui_screen_sensor, LV_SCR_LOAD_ANIM_MOVE_LEFT, 400, 0);
}
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT  ) {
      _ui_screen_change( ui_screen_setting, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 400, 0);
}
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_BOTTOM  ) {
      ui_screen_last = ui_screen_time;
      _ui_screen_change( ui_screen_wifi, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, 400, 0);
}
}
...
if ( event_code == LV_EVENT_CLICKED) {
      ui_screen_last = ui_screen_time;
      _ui_screen_change( ui_screen_wifi, LV_SCR_LOAD_ANIM_OVER_BOTTOM, 300, 0);
}
}
void ui_event_screen_sensor( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT  ) {
      _ui_screen_change( ui_screen_time, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 300, 0);
}
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT  ) {
      _ui_screen_change( ui_screen_setting, LV_SCR_LOAD_ANIM_MOVE_LEFT, 300, 0);
}
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_TOP  ) {
      _ui_screen_change( ui_screen_time, LV_SCR_LOAD_ANIM_MOVE_TOP, 300, 0);
}
}
void ui_event_wifi__st_button_2( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
...
void ui_event_screen_setting( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT  ) {
      _ui_screen_change( ui_screen_time, LV_SCR_LOAD_ANIM_MOVE_LEFT, 300, 0);
}
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT  ) {
      _ui_screen_change( ui_screen_sensor, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 300, 0);
}
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_TOP  ) {
      _ui_screen_change( ui_screen_time, LV_SCR_LOAD_ANIM_MOVE_TOP, 300, 0);
}
...
void ui_event_setting_display( lv_event_t * e) {
    ...
    lv_obj_t * cur_screen = lv_scr_act();
if ( event_code == LV_EVENT_CLICKED &&  cur_screen == ui_screen_setting ) {
      _ui_screen_change( ui_screen_display, LV_SCR_LOAD_ANIM_OVER_BOTTOM, 300, 0);
}
}
void ui_event_setting_time( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
    lv_obj_t * cur_screen = lv_scr_act();
if ( event_code == LV_EVENT_CLICKED &&  cur_screen == ui_screen_setting ) {
      _ui_screen_change( ui_screen_date_time, LV_SCR_LOAD_ANIM_OVER_BOTTOM, 300, 0);
}
}
void ui_event_back1( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
if ( event_code == LV_EVENT_CLICKED) {
      _ui_screen_change( ui_screen_setting, LV_SCR_LOAD_ANIM_OVER_TOP, 300, 0);
}
}
void ui_event_screen_always_on_cfg( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
...
if ( event_code == LV_EVENT_CLICKED) {
      ...
      _ui_screen_change( ui_screen_last, LV_SCR_LOAD_ANIM_OVER_TOP, 300, 0);
}
}
...
if ( event_code == LV_EVENT_CLICKED) {
      ...
      _ui_screen_change( ui_screen_sensor, LV_SCR_LOAD_ANIM_OVER_RIGHT, 300, 0);
}
}
...
lv_obj_set_style_bg_opa(ui_hour, 175, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_bg_opa(ui_min, 175, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_bg_opa(ui_location, 175, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_border_opa(ui_location, 175, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_bg_opa(ui_date_panel, 175, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_border_opa(ui_date_panel, 175, LV_PART_MAIN| LV_STATE_DEFAULT);
...
ui_background = lv_img_create(ui_screen_sensor);
lv_img_set_src(ui_background, &ui_img_background_png);
lv_obj_set_width( ui_background, lv_pct(100));
lv_obj_set_height( ui_background, lv_pct(100));
lv_obj_set_align( ui_background, LV_ALIGN_CENTER );
...
lv_obj_set_width( ui_co2, 140);
lv_obj_set_height( ui_co2, 160);
lv_obj_set_x( ui_co2, -148 );
...
lv_obj_set_x( ui_co2_title, 15 );
lv_obj_set_y( ui_co2_title, -50 );
...
lv_obj_set_width( ui_co2_data, 80);
lv_obj_set_height( ui_co2_data, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_co2_data, -30 );
lv_obj_set_y( ui_co2_data, 10 );
...
lv_obj_set_x( ui_co2_unit, 44 );
lv_obj_set_y( ui_co2_unit, 10 );
...
ui_tds = lv_btn_create(ui_screen_sensor);
lv_obj_set_width( ui_tds, 140);
lv_obj_set_height( ui_tds, 160);
lv_obj_set_x( ui_tds, 148 );
lv_obj_set_y( ui_tds, -100 );
lv_obj_set_align( ui_tds, LV_ALIGN_CENTER );
lv_obj_add_flag( ui_tds, LV_OBJ_FLAG_SCROLL_ON_FOCUS );   /// Flags
lv_obj_clear_flag( ui_tds, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
lv_obj_set_style_bg_color(ui_tds, lv_color_hex(0xF84646), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_opa(ui_tds, 255, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_tds_icon = lv_img_create(ui_tds);
lv_img_set_src(ui_tds_icon, &ui_img_tds_png);
lv_obj_set_width( ui_tds_icon, LV_SIZE_CONTENT);  /// 44
lv_obj_set_height( ui_tds_icon, LV_SIZE_CONTENT);   /// 53
lv_obj_set_x( ui_tds_icon, -40 );
lv_obj_set_y( ui_tds_icon, -50 );
lv_obj_set_align( ui_tds_icon, LV_ALIGN_CENTER );
lv_obj_add_flag( ui_tds_icon, LV_OBJ_FLAG_ADV_HITTEST );   /// Flags
lv_obj_clear_flag( ui_tds_icon, LV_OBJ_FLAG_SCROLLABLE );    /// Flags

ui_tds_title = lv_label_create(ui_tds);
lv_obj_set_width( ui_tds_title, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_tds_title, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_tds_title, 15 );
lv_obj_set_y( ui_tds_title, -50 );
lv_obj_set_align( ui_tds_title, LV_ALIGN_CENTER );
lv_label_set_text(ui_tds_title,"TDS");
lv_obj_set_style_text_font(ui_tds_title, &ui_font_font0, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_tds_data = lv_label_create(ui_tds);
lv_obj_set_width( ui_tds_data, 80);
lv_obj_set_height( ui_tds_data, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_tds_data, -30 );
lv_obj_set_y( ui_tds_data, 10 );
lv_obj_set_align( ui_tds_data, LV_ALIGN_CENTER );
lv_label_set_text(ui_tds_data,"N/A ");
lv_obj_set_style_text_align(ui_tds_data, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_tds_data, &ui_font_font2, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_tds_unit = lv_label_create(ui_tds);
lv_obj_set_width( ui_tds_unit, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_tds_unit, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_tds_unit, 44 );
lv_obj_set_y( ui_tds_unit, 10 );
lv_obj_set_align( ui_tds_unit, LV_ALIGN_CENTER );
lv_label_set_text(ui_tds_unit,"ppm");
lv_obj_set_style_text_font(ui_tds_unit, &ui_font_font0, LV_PART_MAIN| LV_STATE_DEFAULT);

///////////////////TDS END////////////////////////////////////////

////////////////////////EC/////////////////////////////////

ui_ec = lv_btn_create(ui_screen_sensor);
lv_obj_set_width( ui_ec, 140);
lv_obj_set_height( ui_ec, 160);
lv_obj_set_x( ui_ec, 148 );
lv_obj_set_y( ui_ec, 85 );
lv_obj_set_align( ui_ec, LV_ALIGN_CENTER );
lv_obj_add_flag( ui_ec, LV_OBJ_FLAG_SCROLL_ON_FOCUS );   /// Flags
lv_obj_clear_flag( ui_ec, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
lv_obj_set_style_bg_color(ui_ec, lv_color_hex(0x9B5A97), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_opa(ui_ec, 255, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_ec_icon = lv_img_create(ui_ec);
lv_img_set_src(ui_ec_icon, &ui_img_tds_png);
lv_obj_set_width( ui_ec_icon, LV_SIZE_CONTENT);  /// 44
lv_obj_set_height( ui_ec_icon, LV_SIZE_CONTENT);   /// 53
lv_obj_set_x( ui_ec_icon, -40 );
lv_obj_set_y( ui_ec_icon, -50 );
lv_obj_set_align( ui_ec_icon, LV_ALIGN_CENTER );
lv_obj_add_flag( ui_ec_icon, LV_OBJ_FLAG_ADV_HITTEST );   /// Flags
lv_obj_clear_flag( ui_ec_icon, LV_OBJ_FLAG_SCROLLABLE );    /// Flags

ui_ec_title = lv_label_create(ui_ec);
lv_obj_set_width( ui_ec_title, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_ec_title, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_ec_title, 15 );
lv_obj_set_y( ui_ec_title, -50 );
lv_obj_set_align( ui_ec_title, LV_ALIGN_CENTER );
lv_label_set_text(ui_ec_title,"EC");
lv_obj_set_style_text_font(ui_ec_title, &ui_font_font0, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_ec_data = lv_label_create(ui_ec);
lv_obj_set_width( ui_ec_data, 80);
lv_obj_set_height( ui_ec_data, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_ec_data, -30 );
lv_obj_set_y( ui_ec_data, 10 );
lv_obj_set_align( ui_ec_data, LV_ALIGN_CENTER );
lv_label_set_text(ui_ec_data,"N/A ");
lv_obj_set_style_text_align(ui_ec_data, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_ec_data, &ui_font_font2, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_ec_unit = lv_label_create(ui_ec);
lv_obj_set_width( ui_ec_unit, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_ec_unit, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_ec_unit, 44 );
lv_obj_set_y( ui_ec_unit, 10 );
lv_obj_set_align( ui_ec_unit, LV_ALIGN_CENTER );
lv_label_set_text(ui_ec_unit,"cm");
lv_obj_set_style_text_font(ui_ec_unit, &ui_font_font0, LV_PART_MAIN| LV_STATE_DEFAULT);

///////////////////EC END////////////////////////////////////////

ui_tvoc_2 = lv_btn_create(ui_screen_sensor);
lv_obj_set_width( ui_tvoc_2, 140);
lv_obj_set_height( ui_tvoc_2, 160);
lv_obj_set_x( ui_tvoc_2, -148 );
lv_obj_set_y( ui_tvoc_2, 85 );
...
lv_obj_set_y( ui_tvoc_icon_2, -50 );
...
lv_obj_set_y( ui_tvoc_title_2, -50 );
...
lv_obj_set_x( ui_tvoc_data, -40 );
lv_obj_set_y( ui_tvoc_data, 10 );
...
lv_obj_set_y( ui_tvoc_unit_2, 10 );
...
lv_obj_set_height( ui_temp2, 160);
lv_obj_set_x( ui_temp2, 0 );
lv_obj_set_y( ui_temp2, -100 );
...
lv_obj_set_y( ui_temp_icon_2, -50 );
...
lv_obj_set_y( ui_temp_title_2, -50 );
...
lv_obj_set_x( ui_temp_data_2, -40 );
lv_obj_set_y( ui_temp_data_2, 10 );
...
lv_obj_set_x( ui_temp_unit_2, 44 );
lv_obj_set_y( ui_temp_unit_2, 10 );
...
lv_obj_set_height( ui_humidity2, 160);
lv_obj_set_x( ui_humidity2, 0 );
lv_obj_set_y( ui_humidity2, 85 );
...
lv_obj_set_y( ui_humidity_icon_2, -50 );
...
lv_obj_set_y( ui_humidity_title_2, -50 );
...
lv_obj_set_x( ui_humidity_data_2, -40 );
lv_obj_set_y( ui_humidity_data_2, 10 );
...
lv_obj_set_x( ui_humidity_unit_2, 44 );
lv_obj_set_y( ui_humidity_unit_2, 10 );
...
// lv_obj_set_x( ui_auto_update, 0 );//hashed
// lv_obj_set_y( ui_auto_update, -60 );//hashed
...
// lv_obj_set_x( ui_time_zone, 0 );//hashed
// lv_obj_set_y( ui_time_zone, 88 );//hashed
...
// lv_obj_set_y( ui_date_cfg, 60 );//hashed
...
// lv_obj_set_y( ui_hour_cfg, 60 );//hashed
...
// lv_obj_set_y( ui_min_cfg, 60 );//hashed
...
// lv_obj_set_y( ui_sec_cfg, 60 );//hashed
...
// lv_obj_set_y( ui_time_label1, 60 );//hashed
...
// lv_obj_set_y( ui_time_label2, 60 );//hashed

...
//////////////////////////////TDS///////////////////////////////////////////////////////////
                case SENSOR_DATA_TDS: {
                    snprintf(data_buf, sizeof(data_buf), "%d", (int)p_data->vaule);
                    ESP_LOGI(TAG, "update tds:%s", data_buf);
                    lv_label_set_text(ui_tds_data, data_buf);
                    break;
                }
/////////////////////////////TDS END///////////////////////////////////////////////////////
...
//////////////////////////////EC///////////////////////////////////////////////////////////
                case SENSOR_DATA_EC: {
                    snprintf(data_buf, sizeof(data_buf), "%d", (int)p_data->vaule);
                    ESP_LOGI(TAG, "update ec:%s", data_buf);
                    lv_label_set_text(ui_tds_data, data_buf);
                    break;
                }
/////////////////////////////EC END///////////////////////////////////////////////////////
...
////////////////////////TDS//////////////////////////////////////////
                case SENSOR_DATA_TDS: {
                    sensor_chart.color = lv_color_hex(0xF84646);
                    sensor_chart.p_info = p_data;
                    strcpy(sensor_chart.name, "TDS");
                    break;
                }
//////////////////////TDS END///////////////////////////////////////
...
////////////////////////EC//////////////////////////////////////////
                case SENSOR_DATA_EC: {
                    sensor_chart.color = lv_color_hex(0x9B5A97);
                    sensor_chart.p_info = p_data;
                    strcpy(sensor_chart.name, "EC");
                    break;
                }
//////////////////////EC END///////////////////////////////////////

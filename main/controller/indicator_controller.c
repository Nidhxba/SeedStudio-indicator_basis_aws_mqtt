...
static void ui_event_sensor_tds_chart( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
    lv_obj_t * cur_screen = lv_scr_act();
if ( event_code == LV_EVENT_CLICKED &&  cur_screen == ui_screen_sensor ) {
    esp_event_post_to(view_event_handle, VIEW_EVENT_BASE, VIEW_EVENT_SENSOR_TDS_HISTORY, NULL, 0, portMAX_DELAY);
...
static void ui_event_sensor_ec_chart( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
    lv_obj_t * cur_screen = lv_scr_act();
if ( event_code == LV_EVENT_CLICKED &&  cur_screen == ui_screen_sensor ) {
    esp_event_post_to(view_event_handle, VIEW_EVENT_BASE, VIEW_EVENT_SENSOR_EC_HISTORY, NULL, 0, portMAX_DELAY);
...
static void __sensor_chart_event_init(void)
{
    ...
    lv_obj_add_event_cb(ui_tds, ui_event_sensor_tds_chart, LV_EVENT_ALL, NULL);
    lv_obj_add_event_cb(ui_ec, ui_event_sensor_ec_chart, LV_EVENT_ALL, NULL);
